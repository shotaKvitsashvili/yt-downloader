    ...
    return <>
        ...
        <div className='mt-10'>
            <p className='text-center color-text'>
                Youtubetomp3.ge საშუალებას გაძლევთ ჩამოტვირთოთ და გადაიყვანოთ YouTube ვიდეო MP3 მუსიკად მაღალი ხარისხით 320 kbps-მდე. მხარდაჭერილი ყველა პოპულარული ფორმატი მოიცავს MP4, MP3, FLV, M4V, WMV და WEBM. შეგიძლიათ თავისუფლად ჩამოტვირთოთ ვიდეო YouTube-დან და გადაიყვანოთ ისინი MP3 აუდიოზე შეზღუდვის გარეშე.
            </p>
        </div>
    </>;
}
